...
export declare const Experimental: {
    ...
    Solid: import("react").ComponentType<{
        readonly color: string;
        readonly width: number;
        readonly height: number;
    } & Partial<{
        readonly _experimentalEffects: import("./effects/effect-types.js").EffectsProp;
        readonly className: string | undefined;
        readonly style: React.CSSProperties | undefined;
    }> & Pick<import("./Sequence.js").SequenceProps, "hidden" | "name" | "durationInFrames" | "from" | "showInTimeline"> & import("react").RefAttributes<HTMLCanvasElement>>;
    useIsPlayer: () => boolean;
};
